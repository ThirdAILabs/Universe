...
def process_pdf_file_new(filename):
    try:
        rows = []
        prev = ""
        ...
        for page_number, page in enumerate(doc):
            if page_number < 85 or page_number > 90:
                continue
...
if __name__ == "__main__":
    rows, _ = process_pdf_file_new("/Users/kartiksarangmath/Downloads/Document.pdf")