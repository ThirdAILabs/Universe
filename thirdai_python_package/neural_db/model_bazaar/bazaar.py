...
class Bazaar:
    def __init__(
        ...
        base_url: str = "https://model-zoo.azurewebsites.net/",
    ):
        self._base_url = base_url
        self._cache_dir = Path(cache_dir)  # Just in case we're given a string.
    ...
    # TODO: On_progress
    def get_model_dir(
        self, identifier: str, on_progress: Callable = lambda *args, **kwargs: None
    ):
