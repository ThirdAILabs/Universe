...
static void print_to_file() {
  std::string origin =
      "We brought you a lot of car plants, Michigan. We brought you a lot of car plants. You know that," 
      "right? Long time, it's been a long time since you had all these plants being built, but we brought "
