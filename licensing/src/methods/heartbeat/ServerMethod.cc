...
ServerMethod::ServerMethod(std::string heartbeat_url,
...
void ServerMethod::checkLicense() { _heartbeat_thread.verify(); }

LicenseState ServerMethod::getLicenseState() {
  LicenseState license_state;
  license_state.server_state = {_heartbeat_url, _heartbeat_timeout};
