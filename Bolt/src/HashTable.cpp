...
HashTable<Label_t, Hash_t>::HashTable(uint64_t _num_tables, uint64_t _reservoir_size,
...
template <typename Label_t, typename Hash_t>
void HashTable<Label_t, Hash_t>::InsertSequential(uint64_t n, Label_t start, Hash_t* hashes) {
...
template <typename Label_t, typename Hash_t>
void HashTable<Label_t, Hash_t>::GetCandidates(Hash_t* hashes, std::unordered_set<Label_t>& store) {
