...
args["skipwords"]=['youtube','twitter','login','auth','reddit','google',"pinterest","facebook","ytube"]
...
args["start_urls"]=["https://openai.com/api/","https://www.healthline.com/health/food-nutrition/beetroot-juice-benefits"]
