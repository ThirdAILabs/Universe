...
class Unigram : public Transformation {
  Unigram(std::string input_column_name, std::string output_column_name,
  ...
  void apply(ColumnMap& column_map) final {
    auto column = column_map.getSparseValueColumn(_input_column_name);
