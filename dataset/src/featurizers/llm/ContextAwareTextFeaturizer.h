...
class ContextAwareTextFeaturizer final : public Featurizer {
 public:
  ...
  static ContextAwareTextFeaturizerPtr load(const std::string& filename);

  static ContextAwareTextFeaturizerPtr load_stream(std::istream& input_stream);

 private:
  // Private Constructor for Cereal
  ContextAwareTextFeaturizer() {}
