...
//   auto records =
//       UserItemHistoryBlock::makeEmptyRecord(user_id_map->size(),
//       track_last_n);
...
// // TODO: Change TEST to use StreamingStringLookup!!!
...
//   auto batch = processSamples(samples, user_id_seq, item_id_seq,
//   track_last_n); assertItemHistoryValid(batch, user_id_seq, item_id_seq,
//   n_items); assertItemHistoryNotStagnant(batch, user_id_seq, n_users);
