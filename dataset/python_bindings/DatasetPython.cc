...
void createDatasetSubmodule(py::module_& module) {
  ...
  py::class_<DatasetLoader, DatasetLoaderPtr>(dataset_submodule,
      ...
      .def("load_in_memory", &DatasetLoader::loadInMemory, py::arg("batch_size"),
           py::arg("verbose") = true)
      .def("stream_in_memory", &dataset::DatasetLoader::streamInMemory,
           py::arg("batch_size"), py::arg("num_batches"), py::arg("verbose") = true)
  ...
  dataset_submodule.def(
      ...
      py::arg("data_source"), py::arg("batch_size"), py::arg("softmax_for_multiclass") = true,
