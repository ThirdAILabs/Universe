...
hidden_layer1 = bolt.graph.FullyConnected(dim=1000, sparsity=0.2, activation="relu")(
    input_layer
)
...
hidden_layer3 = bolt.graph.FullyConnected(dim=1000, sparsity=0.2, activation="relu")(
    concat
)
output_layer = bolt.graph.FullyConnected(dim=2, activation="softmax")(hidden_layer3)
