...
if(PROJECT_VERSION_FILE)
  ...
  file(STRINGS ${CMAKE_CURRENT_SOURCE_DIR}/thirdai.version
       PROJECT_VERSION_STRING)
endif()
...
# Print all variables for debugging message(STATUS
# ${PROJECT_VERSION_STRING_FULL}) message(STATUS ${PROJECT_VERSION_STRING})
# message(STATUS ${PROJECT_VERSION_MAJOR}) message(STATUS
# ${PROJECT_VERSION_MINOR}) message(STATUS ${PROJECT_VERSION_PATCH})
# message(STATUS ${PROJECT_VERSION_TWEAK}) message(STATUS
# ${PROJECT_VERSION_GIT_SHA})
