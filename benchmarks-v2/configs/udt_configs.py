...
class YelpPolarityUDTConfig(BenchmarkConfig):
...
class AmazonPolarityUDTConfig(BenchmarkConfig):
    train_file = (
...
class CriteoUDTConfig(BenchmarkConfig):
...
class WayfairUDTConfig(BenchmarkConfig):
