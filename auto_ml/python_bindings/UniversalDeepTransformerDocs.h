...
const char* const UDT_QUERY_REFORMULATION_TRAIN = R"pbdoc(
...
const char* const UDT_QUERY_REFORMULATION_EVALUATE = R"pbdoc(
...
const char* const UDT_QUERY_REFORMULATION_PREDICT = R"pbdoc(
Performs inference on a single sample.
...
const char* const UDT_PREDICT_BATCH_QUERY_REFORMULATION = R"pbdoc(
...
const char* const UDT_QUERY_REFORMULATION_LOAD = R"pbdoc(
