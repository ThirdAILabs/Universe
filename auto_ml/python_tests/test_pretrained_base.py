...
def test_pretrained_base(create_simple_dataset, download_bert_base_uncased):
    ...
    pretrained_mach_models = bolt.PretrainedBase(
        "target", models, indexes, tokenizer, True
    )
    ...
    top_tokens = pretrained_mach_models.get_top_tokens("Hello! How are you!", 10, 20)

    pretrained_mach_models.save("./pretrained_mach_model")

    pretrained_mach_model_load = bolt.PretrainedBase.load("./pretrained_mach_model")
