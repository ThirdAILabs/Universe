...
class UDTQueryCandidateGenerator : public UDTBase {
 ...
 public:
   ...
   * "large"]
   */
  static UDTQueryCandidateGenerator buildUDT(
    ...
    return UDTQueryCandidateGenerator(std::move(generator));
  }
  ...
  static std::shared_ptr<UDTQueryCandidateGenerator> load(
 ...
 private:
  ...
  void serialize(Archive& archive) {
    archive(cereal::base_class<UDTBase>(this), _generator);
  }
};

using UDTQueryCandidateGeneratorPtr =
    std::shared_ptr<UDTQueryCandidateGenerator>;
