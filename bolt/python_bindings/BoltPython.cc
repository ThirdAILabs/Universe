  ...
  */
  ...
  py::class_<PySequentialClassifier>(bolt_submodule, "SequentialClassifier")
      .def(
          ...
          py::arg("size"), py::arg("track_per"), py::arg("timestamp"),
          py::arg("target"), py::arg("lookahead") = 0, py::arg("lookback") = 0,
          ...
          py::arg("metrics") = std::vector<std::string>({"categorical_accuracy"}))
