    ...
    py_class
        ...
        .def("train",
             py::overload_cast<const std::shared_ptr<dataset::DataLoader>&,
                 ...
                 &CLASSIFIER::train),
             py::arg("data_source"), py::arg("epochs"),
...
#pragma message("THIRDAI_EXPOSE_ALL is defined")                   // NOLINT
    ...
    */
    ...
    py::class_<BinaryCrossEntropyLoss, std::shared_ptr<BinaryCrossEntropyLoss>,
               LossFunction>(bolt_submodule, "BinaryCrossEntropyLoss",
    ...
    py::class_<MeanSquaredError, std::shared_ptr<MeanSquaredError>,
               LossFunction>(bolt_submodule, "MeanSquaredError",
     ...
     */
    py::class_<TextClassifier> text_classifier(bolt_submodule,
                                               "TextClassifier");
    ...
    py::class_<SequentialClassifier>(
        bolt_submodule, "SequentialClassifier",
