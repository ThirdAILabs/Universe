...
class ShallowMixer {
 public:
  ShallowMixer(std::vector<FullyConnectedLayerConfig> configs,
  ...
  void perPatchForward(uint32_t batch_index, const VectorState& input);

  // TODO: Need to take in patch size and image size
