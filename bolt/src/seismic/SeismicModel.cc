...
Dataset SeismicModel::convertToBatches(const NumpyArray& array,
...
Dataset SeismicModel::makeLabelBatches(
...
std::pair<ModelPtr, ComputationPtr> SeismicModel::buildModel(
