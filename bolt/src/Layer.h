...
struct SamplingConfig {
  uint32_t num_hashes_per_table, num_tables, range_pow, reservoir_size;

  SamplingConfig()
      : num_hashes_per_table(0),
        num_tables(0),
        range_pow(0),
        reservoir_size(0) {}

  SamplingConfig(uint32_t num_hashes_per_table, uint32_t num_tables,
