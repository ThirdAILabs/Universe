 ...
 public:
  ...
  static void writeSimpleTrendClassificationDataset() {
    ...
    for (uint32_t cycle = 0; cycle < n_cycles; cycle++) {
      ...
      writeSamplesToFile(train_out, time_gen, trend_gen, /* n_items = */ 200, "stagnant", /* repetitions = */ 30);
      writeSamplesToFile(train_out, time_gen, trend_gen, /* n_items = */ 200, "increasing", /* repetitions = */ 100);
      trend_gen.startStagnating();
      writeSamplesToFile(train_out, time_gen, trend_gen, /* n_items = */ 200, "stagnant", /* repetitions = */ 30);
      writeSamplesToFile(train_out, time_gen, trend_gen, /* n_items = */ 200, "stagnant", /* repetitions = */ 30);
      trend_gen.startDecreasing();
      writeSamplesToFile(train_out, time_gen, trend_gen, /* n_items = */ 200, "stagnant", /* repetitions = */ 30);
      writeSamplesToFile(train_out, time_gen, trend_gen, /* n_items = */ 200, "decreasing", /* repetitions = */ 100);
      trend_gen.startStagnating();
      writeSamplesToFile(train_out, time_gen, trend_gen, /* n_items = */ 200, "stagnant", /* repetitions = */ 30);
      writeSamplesToFile(train_out, time_gen, trend_gen, /* n_items = */ 200, "stagnant", /* repetitions = */ 30);
    }
    ...
    */
    ...
    trend_gen.startDecreasing();
    writeSamplesToFile(test_out, time_gen, trend_gen, /* n_items = */ 200, "stagnant", /* repetitions = */ 30);
    writeSamplesToFile(test_out, time_gen, trend_gen, /* n_items = */ 200, "decreasing", /* repetitions = */ 150);
    trend_gen.startIncreasing();
    writeSamplesToFile(test_out, time_gen, trend_gen, /* n_items = */ 200, "stagnant", /* repetitions = */ 30);
    writeSamplesToFile(test_out, time_gen, trend_gen, /* n_items = */ 200, "increasing", /* repetitions = */ 150);
    test_out.close();
  }
...
TEST_F(SequentialClassifierTests, SimpleTrendClassification) {
  ...
  SequentialClassifier seq_bolt({{"item", item_col},
  ...
  seq_bolt.train(simple_trend_train_dataset, /* epochs = */ 1, /* learning_rate = */ 0.0001);
