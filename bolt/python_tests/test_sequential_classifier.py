...
def test_sequential_classifier_api(): 
    with open("hello.txt", "w") as hello:
        hello.write("discard_col,item_col,timestamp_col,target_col,text_col_1,text_col_2,text_col_3,cat_col_1,cat_col_2,cat_col_3,trackable_qty_1,trackable_qty_2,trackable_qty_3,trackable_cat_1,trackable_cat_2\n")
        hello.write("ignore,best class,2021-01-01,not_best,hello there,hello there too,hello there three,arbitrary_class_0,arbitrary_class_1,arbitrary_class_2,0.35,0.33,0.31,1,2\n")
