...
def test_sgd():
    n_classes = 20
    train_data, train_labels = gen_numpy_training_data(n_classes=n_classes, n_samples=5000, batch_size_for_conversion=100)
    test_data, test_labels = gen_numpy_training_data(n_classes=n_classes, n_samples=1000)
