...
def test_load_save_fc_network():
    ...
    assert resume_acc["categorical_accuracy"] == original_acc["categorical_accuracy"]
    assert (
        wrong_resume_acc["categorical_accuracy"] == original_acc["categorical_accuracy"]
    )
    assert (
        wrong_load_acc["categorical_accuracy"] == original_acc["categorical_accuracy"]
    )
    ...
    assert (
        another_acc_resume["categorical_accuracy"] >= resume_acc["categorical_accuracy"]
    )
