...
def gen_numpy_training_data(n_classes=10, n_samples=1000, noise_std=0.1,convert_to_bolt_dataset=True):
    ...
    if convert_to_bolt_dataset:
        examples = dataset.from_numpy(examples)
        labels = dataset.from_numpy(labels)
