...
tabular_train_file = "/share/data/tabular_benchmarks/CensusIncome/Train.csv"
tabular_test_file = "/share/data/tabular_benchmarks/CensusIncome/Test.csv"

import pandas as pd

train_df = pd.read_csv("/share/data/tabular_benchmarks/CensusIncome/Train.csv")
test_df = pd.read_csv("/share/data/tabular_benchmarks/CensusIncome/Test.csv")
...
train_config = (bolt.graph.TrainConfig
                    .make(epochs=5, learning_rate=0.0001)
