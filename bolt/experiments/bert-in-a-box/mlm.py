...
train_data, train_tokens, train_labels = mlm_loader.load(filename=TRAIN_DATA, batch_size=BATCH_SIZE)

test_data, test_tokens, test_labels = mlm_loader.load(filename=TEST_DATA, batch_size=BATCH_SIZE)
