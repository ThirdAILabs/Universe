...
NerTokenFromStringArray::NerTokenFromStringArray(std::string source_column,
...
std::vector<size_t> computeOffsets(const ArrayColumnBasePtr<std::string>& texts) {
...
ColumnMap NerTokenFromStringArray::apply(ColumnMap columns, State& state) const {
  (void)state;
